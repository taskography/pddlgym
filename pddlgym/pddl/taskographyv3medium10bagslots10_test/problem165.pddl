...
(define (problem NaturalTaskographyv3Medium10Bagslots10Problem165) (:domain taskographyv3medium10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item82_clock_mediumitem receptacle43_bed)
	(inreceptacle item11_bottle_smallitem receptacle16_chair)
	(inreceptacle item83_vase_mediumitem receptacle15_chair)
	(inreceptacle item81_clock_mediumitem receptacle55_toilet)
	(inreceptacle item41_potted_plant_largeitem receptacle64_oven)
	(inreceptacle item3_umbrella_largeitem receptacle72_sink)
