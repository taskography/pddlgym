...
(define (problem SwormvilleTaskographyv3Medium10Bagslots10Problem181) (:domain taskographyv3medium10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item8_bottle_smallitem receptacle5_sink)
	(inreceptacle item9_bottle_smallitem receptacle35_bed)
	(inreceptacle item29_potted_plant_largeitem receptacle16_chair)
	(inreceptacle item12_clock_mediumitem receptacle13_toilet)
	(inreceptacle item31_potted_plant_largeitem receptacle21_chair)
	(inreceptacle item30_potted_plant_largeitem receptacle5_sink)
	(inreceptacle item28_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item32_potted_plant_largeitem receptacle23_chair)))
)
