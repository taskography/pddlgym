...
(define (problem SandsTaskographyv3Medium10Bagslots10Problem175) (:domain taskographyv3medium10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item26_potted_plant_largeitem receptacle13_refrigerator)
	(inreceptacle item27_potted_plant_largeitem receptacle11_refrigerator)
	(inreceptacle item16_bottle_smallitem receptacle11_refrigerator)
	...
	(inreceptacle item5_surfboard_largeitem receptacle24_couch)
	(inreceptacle item4_surfboard_largeitem receptacle1_oven)))
)
