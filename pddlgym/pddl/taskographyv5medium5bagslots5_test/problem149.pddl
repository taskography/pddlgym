...
(define (problem MartinvilleTaskographyv5Medium5Bagslots5Problem149) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos9_Yneg55_place14_room17_floorB)
	...
	(inplace robot place14_door_room17_lobby)
	...
	(receptacleclass receptacle52_microwave microwave)
	...
	(smallitem item7_spoon_smallitem)
  )
  (:goal (and
	(classrelation bottle chair)
	(classrelation clock chair)
	(classrelation surfboard diningtable)
