...
(define (problem ChilhowieTaskographyv5Medium5Bagslots5Problem115) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg54_Ypos39_place11_room1_floorA)
  ...
  (:goal (and
	...
	(classrelation banana toilet)
	(classrelation handbag microwave)))
)
