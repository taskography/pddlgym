...
(define (problem TilghmantonTaskographyv5Medium5Bagslots5Problem53) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos4_Ypos84_place1_room16_floorA)
	...
	(inplace robot place1_door_room16_living_room)
