...
(define (problem AirportTaskographyv5Medium5Bagslots5Problem143) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg35_Ypos11_place2_room5_floorB)
	...
	(inplace robot place2_door_room5_childs_room)
