...
(define (problem RogueTaskographyv5Medium5Bagslots5Problem109) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg63_Yneg31_place4_room17_floorA)
	...
	(inplace robot place4_door_room17_utility_room)
	...
	(inroom robot room17_utility_room)
	...
	(itemclass item5_surfboard_largeitem surfboard)
	...
	(smallitem item13_orange_smallitem)
