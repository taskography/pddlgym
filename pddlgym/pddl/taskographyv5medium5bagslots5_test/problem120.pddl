...
(define (problem ChurchtonTaskographyv5Medium5Bagslots5Problem120) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos32_Ypos8_place12_room5_floorC)
	...
	(itemclass item5_kite_largeitem kite)
	(itemclass item60_clock_mediumitem clock)
	(itemclass item61_vase_mediumitem vase)
	(itemclass item62_toothbrush_smallitem toothbrush)
	(itemclass item63_toothbrush_smallitem toothbrush)
	...
	(largeitem item5_kite_largeitem)
