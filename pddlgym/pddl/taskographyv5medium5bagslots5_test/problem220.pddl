...
(define (problem IrvineTaskographyv5Medium5Bagslots5Problem220) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg66_Ypos18_place11_room7_floorB)
	...
	(inplace robot place11_door_room7_childs_room)
