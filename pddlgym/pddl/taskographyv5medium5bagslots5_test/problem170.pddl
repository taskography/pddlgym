...
(define (problem BautistaTaskographyv5Medium5Bagslots5Problem170) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item10_tie_smallitem tie)
	(itemclass item11_tie_smallitem tie)
	(itemclass item12_tie_smallitem tie)
	...
	(itemclass item24_surfboard_largeitem surfboard)
	...
	(largeitem item24_surfboard_largeitem)
	...
	(smallitem item10_tie_smallitem)
	(smallitem item11_tie_smallitem)
	(smallitem item12_tie_smallitem)
