...
(define (problem ArkansawTaskographyv5Medium5Bagslots5Problem144) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos12_Yneg29_place14_room3_floorC)
	...
	(inplace robot place14_door_room3_bathroom)
