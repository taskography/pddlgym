...
(define (problem SweatmanTaskographyv5Medium5Bagslots5Problem74) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg55_Ypos45_place4_room2_floorA)
	...
	(itemclass item56_mouse_smallitem mouse)
	(itemclass item57_mouse_smallitem mouse)
	...
	(smallitem item57_mouse_smallitem)
