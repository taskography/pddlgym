...
(define (problem TimberonTaskographyv5Medium5Bagslots5Problem134) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos3_Ypos5_place13_room3_floorC)
	...
	(inplace robot place13_door_room3_bathroom)
	...
	(itemclass item55_mouse_smallitem mouse)
	(itemclass item56_remote_smallitem remote)
	(itemclass item57_keyboard_largeitem keyboard)
	(itemclass item58_keyboard_largeitem keyboard)
	...
	(largeitem item57_keyboard_largeitem)
	...
	(smallitem item55_mouse_smallitem)
