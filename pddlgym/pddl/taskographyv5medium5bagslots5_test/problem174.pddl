...
(define (problem GoodyearTaskographyv5Medium5Bagslots5Problem174) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item8_kite_largeitem kite)
	...
	(receptacleclass receptacle1_boat boat)
  ...
  (:goal (and
	...
	(classrelation vase boat)
	(classrelation bowl boat)
	(classrelation clock chair)
	(classrelation pottedplant boat)))
)
