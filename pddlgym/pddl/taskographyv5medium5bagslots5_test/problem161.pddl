...
(define (problem TokelandTaskographyv5Medium5Bagslots5Problem161) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg35_Ypos35_place13_room6_floorB)
	...
	(inplace robot place13_door_room6_corridor)
