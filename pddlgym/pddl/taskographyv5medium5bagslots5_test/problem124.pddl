...
(define (problem SoldierTaskographyv5Medium5Bagslots5Problem124) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item6_kite_largeitem kite)
	...
	(receptacleclass receptacle49_microwave microwave)
	(receptacleclass receptacle50_microwave microwave)
