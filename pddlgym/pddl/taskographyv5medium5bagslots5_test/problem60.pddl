...
(define (problem HainesburgTaskographyv5Medium5Bagslots5Problem60) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos14_Ypos52_place2_room16_floorB)
	...
	(inplace robot place2_door_room16_kitchen)
