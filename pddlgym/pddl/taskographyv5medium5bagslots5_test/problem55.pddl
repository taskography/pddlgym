...
(define (problem HordvilleTaskographyv5Medium5Bagslots5Problem55) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos0_Yneg3_place13_room7_floorC)
	...
	(inplace robot place13_door_room7_closet)
	...
	(itemclass item69_toothbrush_smallitem toothbrush)
	(itemclass item6_cup_smallitem cup)
	(itemclass item70_toothbrush_smallitem toothbrush)
