...
(define (problem ParoleTaskographyv5Medium5Bagslots5Problem180) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg39_Yneg17_place1_room1_floorA)
