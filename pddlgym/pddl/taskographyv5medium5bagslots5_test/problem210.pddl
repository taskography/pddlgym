...
(define (problem OyensTaskographyv5Medium5Bagslots5Problem210) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos9_Yneg78_place8_room6_floorA)
	...
	(inplace robot place8_door_room6_corridor)
	...
	(itemclass item20_toothbrush_smallitem toothbrush)
