...
(define (problem BrownTaskographyv5Medium5Bagslots5Problem119) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg67_Yneg1_place19_room21_floorB)
	...
	(inplace robot place19_door_room21_empty_room)
