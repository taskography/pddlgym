...
(define (problem AnnonaTaskographyv5Medium5Bagslots5Problem84) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos19_Ypos5_place8_room14_floorB)
	...
	(inplace robot place8_door_room14_living_room)
