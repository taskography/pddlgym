...
(define (problem NuevoTaskographyv5Medium5Bagslots5Problem195) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item28_spoon_smallitem spoon)
	...
	(smallitem item28_spoon_smallitem)
  )
  (:goal (and
