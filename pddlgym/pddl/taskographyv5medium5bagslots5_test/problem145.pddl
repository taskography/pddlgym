...
(define (problem ArkansawTaskographyv5Medium5Bagslots5Problem145) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos8_Yneg15_place2_room12_floorA)
	...
	(inplace robot place2_door_room12_home_office)
