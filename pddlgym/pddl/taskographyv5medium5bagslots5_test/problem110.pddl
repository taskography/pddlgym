...
(define (problem AncorTaskographyv5Medium5Bagslots5Problem110) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos8_Yneg2_place3_room9_floorB)
	...
	(inplace robot place3_door_room9_kitchen)
	...
	(itemclass item51_suitcase_largeitem suitcase)
	...
	(largeitem item51_suitcase_largeitem)
