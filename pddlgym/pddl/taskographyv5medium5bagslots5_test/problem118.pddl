...
(define (problem BrownTaskographyv5Medium5Bagslots5Problem118) (:domain taskographyv5medium5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg20_Yneg6_place8_room6_floorC)
	...
	(inplace robot place8_door_room6_bathroom)
	...
	(itemclass item1_baseball_bat_largeitem baseballbat)
	...
	(mediumitem item24_clock_mediumitem)
	...
	(receptacleclass receptacle12_sink sink)
	...
	(receptacleclass receptacle30_bench bench)
	(receptacleclass receptacle31_bench bench)
	...
	(smallitem item33_bowl_smallitem)
  )
  (:goal (and
