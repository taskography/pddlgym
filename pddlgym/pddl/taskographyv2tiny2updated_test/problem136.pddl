...
(define (problem MarkleevilleTaskographyv2Tiny2Problem136) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item40_potted_plant_largeitem receptacle29_chair)
	(inreceptacle item10_cup_smallitem receptacle36_couch)))
)
