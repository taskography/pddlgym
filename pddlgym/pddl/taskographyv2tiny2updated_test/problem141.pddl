...
(define (problem BenevolenceTaskographyv2Tiny2Problem141) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item12_bottle_smallitem receptacle38_dining_table)
	(inreceptacle item13_bottle_smallitem receptacle37_dining_table)))
)
