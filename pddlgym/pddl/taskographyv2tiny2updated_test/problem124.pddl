...
(define (problem LindenwoodTaskographyv2Tiny2Problem124) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item40_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle56_bed)))
)
