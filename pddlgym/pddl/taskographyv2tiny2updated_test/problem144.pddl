...
(define (problem BenevolenceTaskographyv2Tiny2Problem144) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item29_potted_plant_largeitem receptacle22_toilet)
	(inreceptacle item11_bottle_smallitem receptacle24_chair)))
)
