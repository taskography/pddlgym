...
(define (problem BenevolenceTaskographyv2Tiny2Problem143) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item13_bottle_smallitem receptacle21_toilet)
	(inreceptacle item10_book_smallitem receptacle32_bed)))
)
