...
(define (problem PomariaTaskographyv2Tiny2Problem149) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item20_potted_plant_largeitem receptacle5_chair)
	(inreceptacle item68_book_smallitem receptacle26_toilet)))
)
