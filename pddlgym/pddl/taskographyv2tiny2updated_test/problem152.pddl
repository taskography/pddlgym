...
(define (problem OnagaTaskographyv2Tiny2Problem152) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item47_potted_plant_largeitem receptacle14_sink)
	(inreceptacle item48_potted_plant_largeitem receptacle53_dining_table)))
)
