...
(define (problem PomariaTaskographyv2Tiny2Problem147) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg58_Ypos52_place16_room13_floorC)
	...
	(inplace robot place16_door_room13_lobby)
  ...
  (:goal (and
	(inreceptacle item77_book_smallitem receptacle26_toilet)
	(inreceptacle item72_book_smallitem receptacle7_chair)))
)
