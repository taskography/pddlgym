...
(define (problem PomariaTaskographyv2Tiny2Problem145) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg68_Yneg10_place4_room10_floorA)
	...
	(inplace robot place4_door_room10_home_office)
  ...
  (:goal (and
	(inreceptacle item91_book_smallitem receptacle7_chair)
	(inreceptacle item94_vase_mediumitem receptacle24_bed)))
)
