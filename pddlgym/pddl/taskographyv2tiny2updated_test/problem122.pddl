...
(define (problem LindenwoodTaskographyv2Tiny2Problem122) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg76_Ypos86_place11_room19_floorA)
	...
	(inplace robot place11_door_room19_dining_room)
	...
	(inroom robot room19_dining_room)
  ...
  (:goal (and
	...
	(inreceptacle item15_bottle_smallitem receptacle24_chair)))
)
