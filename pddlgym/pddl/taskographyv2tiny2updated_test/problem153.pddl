...
(define (problem OnagaTaskographyv2Tiny2Problem153) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item12_book_smallitem receptacle31_chair)
	(inreceptacle item43_potted_plant_largeitem receptacle2_oven)))
)
