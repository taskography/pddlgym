...
(define (problem LindenwoodTaskographyv2Tiny2Problem121) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item55_potted_plant_largeitem receptacle4_sink)
	(inreceptacle item48_potted_plant_largeitem receptacle21_toilet)))
)
