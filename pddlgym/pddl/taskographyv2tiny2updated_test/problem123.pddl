...
(define (problem LindenwoodTaskographyv2Tiny2Problem123) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:init 
	(atlocation robot location_Xneg2_Ypos9_place0_room27_floorA)
	...
	(inplace robot place0_door_room27_kitchen)
  ...
  (:goal (and
	...
	(inreceptacle item48_potted_plant_largeitem receptacle18_toilet)))
)
