...
(define (problem PomariaTaskographyv2Tiny2Problem148) (:domain taskographyv2tiny2)
  (:objects
  ...
  (:goal (and
	(inreceptacle item59_book_smallitem receptacle5_chair)
	(inreceptacle item72_book_smallitem receptacle25_toilet)))
)
