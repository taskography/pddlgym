...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots5Problem78) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg24_Ypos203_place13_room7_floorA)
	...
	(inplace robot place13_door_room7_bedroom)
