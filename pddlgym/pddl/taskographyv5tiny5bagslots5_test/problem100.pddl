...
(define (problem PomariaTaskographyv5Tiny5Bagslots5Problem100) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg59_Ypos32_place7_room16_floorB)
	...
	(inplace robot place7_door_room16_staircase)
	...
	(itemclass item27_tv_largeitem tv)
	(itemclass item28_tv_largeitem tv)
	(itemclass item29_tv_largeitem tv)
	(itemclass item30_tv_largeitem tv)
	(itemclass item31_laptop_mediumitem laptop)
	(itemclass item32_keyboard_largeitem keyboard)
	...
	(largeitem item12_potted_plant_largeitem)
	(largeitem item13_potted_plant_largeitem)
	(largeitem item14_potted_plant_largeitem)
	(largeitem item15_potted_plant_largeitem)
	(largeitem item16_potted_plant_largeitem)
	...
	(mediumitem item31_laptop_mediumitem)
	...
	(receptacleclass receptacle38_refrigerator refrigerator)
	...
	(smallitem item43_book_smallitem)
	(smallitem item44_book_smallitem)
	(smallitem item45_book_smallitem)
	(smallitem item46_book_smallitem)
