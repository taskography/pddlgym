...
(define (problem MarkleevilleTaskographyv5Tiny5Bagslots5Problem90) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos77_Ypos47_place7_room5_floorB)
	...
	(inplace robot place7_door_room5_dining_room)
	...
	(inroom robot room5_dining_room)
