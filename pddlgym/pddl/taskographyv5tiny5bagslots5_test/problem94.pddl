...
(define (problem MarkleevilleTaskographyv5Tiny5Bagslots5Problem94) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos39_Ypos44_place13_room14_floorA)
	...
	(inplace robot place13_door_room14_storage_room)
	...
	(inroom robot room14_storage_room)
