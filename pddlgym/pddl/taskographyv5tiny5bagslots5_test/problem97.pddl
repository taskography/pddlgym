...
(define (problem BenevolenceTaskographyv5Tiny5Bagslots5Problem97) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg3_Ypos4_place0_room11_floorB)
	...
	(inplace robot place0_door_room11_kitchen)
