...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots5Problem77) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg72_Yneg26_place15_room29_floorB)
	...
	(inplace robot place15_door_room29_kitchen)
