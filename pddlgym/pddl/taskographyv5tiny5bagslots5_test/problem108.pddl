...
(define (problem OnagaTaskographyv5Tiny5Bagslots5Problem108) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg35_Yneg7_place3_room5_floorB)
