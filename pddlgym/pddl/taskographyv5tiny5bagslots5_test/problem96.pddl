...
(define (problem BenevolenceTaskographyv5Tiny5Bagslots5Problem96) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos2_Yneg23_place7_room9_floorB)
