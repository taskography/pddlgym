...
(define (problem PomariaTaskographyv5Tiny5Bagslots5Problem103) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg16_Ypos36_place10_room3_floorC)
