...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots5Problem79) (:domain taskographyv5tiny5bagslots5)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg64_Ypos145_place26_room17_floorB)
	...
	(inplace robot place26_door_room17_corridor)
