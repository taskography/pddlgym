...
(define (domain taskographyv5medium5bagslots5scrub)
  (:requirements :typing :equality)
  (:types agent room place location receptacle rclass item iclass bagslot)
  ...
  (:predicates (inroom ?v0 - agent ?v1 - room)
	...
	(receptacleclass ?v0 - receptacle ?v1 - rclass)
	(itemclass ?v0 - item ?v1 - iclass)
	(classrelation ?v0 - iclass ?v1 - rclass)
