...
(define (problem PomariaTaskographyv5Tiny5Bagslots7Problem103) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg106_Yneg1_place1_room12_floorA)
	...
	(inplace robot place1_door_room12_living_room)
