...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots7Problem79) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg76_Ypos82_place31_room24_floorB)
	...
	(inplace robot place31_door_room24_exercise_room)
	...
	(inroom robot room24_exercise_room)
