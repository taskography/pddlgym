...
(define (problem PomariaTaskographyv5Tiny5Bagslots7Problem100) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg49_Yneg4_place5_room8_floorB)
	...
	(inplace robot place5_door_room8_corridor)
