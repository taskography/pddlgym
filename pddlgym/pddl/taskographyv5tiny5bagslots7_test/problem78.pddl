...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots7Problem78) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg39_Ypos193_place28_room21_floorB)
	...
	(inplace robot place28_door_room21_empty_room)
	...
	(inroom robot room21_empty_room)
