...
(define (problem LindenwoodTaskographyv5Tiny5Bagslots7Problem77) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg71_Ypos203_place17_room5_floorB)
	...
	(inplace robot place17_door_room5_bathroom)
