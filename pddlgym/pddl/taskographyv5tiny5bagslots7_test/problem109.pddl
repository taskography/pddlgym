...
(define (problem OnagaTaskographyv5Tiny5Bagslots7Problem109) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg44_Ypos25_place10_room11_floorA)
	...
	(inplace robot place10_door_room11_staircase)
