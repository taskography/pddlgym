...
(define (problem BenevolenceTaskographyv5Tiny5Bagslots7Problem99) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg20_Yneg63_place11_room10_floorA)
	...
	(inplace robot place11_door_room10_empty_room)
