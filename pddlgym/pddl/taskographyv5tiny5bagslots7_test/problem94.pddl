...
(define (problem MarkleevilleTaskographyv5Tiny5Bagslots7Problem94) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos65_Ypos6_place3_room11_floorA)
	...
	(inplace robot place3_door_room11_living_room)
