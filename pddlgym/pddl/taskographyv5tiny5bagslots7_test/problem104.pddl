...
(define (problem PomariaTaskographyv5Tiny5Bagslots7Problem104) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg19_Yneg15_place3_room11_floorA)
	...
	(inplace robot place3_door_room11_kitchen)
