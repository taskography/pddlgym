...
(define (problem BenevolenceTaskographyv5Tiny5Bagslots7Problem98) (:domain taskographyv5tiny5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos5_Yneg66_place3_room1_floorA)
