...
(define (problem hortensetaskographyv5medium5bagslots5problem90) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg15_yneg40_place15_room16_floora)
	...
	(inplace robot place15_door_room16_staircase)
