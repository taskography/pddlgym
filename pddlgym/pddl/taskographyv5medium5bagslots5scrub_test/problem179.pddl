...
(define (problem sandstaskographyv5medium5bagslots5problem179) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_xpos47_ypos15_place1_room11_floorb)
	...
	(inplace robot place1_door_room11_utility_room)
