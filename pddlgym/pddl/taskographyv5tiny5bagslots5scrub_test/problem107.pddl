...
(define (problem onagataskographyv5tiny5bagslots5problem107) (:domain taskographyv5tiny5bagslots5scrub)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg42_yneg12_place2_room1_floora)
