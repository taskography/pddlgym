...
(define (problem onagataskographyv5tiny5bagslots5problem106) (:domain taskographyv5tiny5bagslots5scrub)
  (:objects
        bagslot1 - bagslot
	bagslot2 - bagslot
	bagslot3 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg22_ypos67_place1_room4_floorb)
	...
	(classrelation orange diningtable)
	...
	(inplace robot place1_door_room4_bedroom)
	...
	(itemclass item19_teddy_bear_mediumitem teddybear)
  ...
  (:goal (and
	...
	(classrelation orange microwave)
