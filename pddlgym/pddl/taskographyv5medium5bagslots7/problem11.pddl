...
(define (problem GoodfieldTaskographyv5Medium5Bagslots7Problem11) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos8_Yneg14_place2_room6_floorC)
	...
	(inplace robot place2_door_room6_closet)
