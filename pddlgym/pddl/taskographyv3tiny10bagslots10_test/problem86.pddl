...
(define (problem PomariaTaskographyv3Tiny10Bagslots10Problem86) (:domain taskographyv3tiny10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item39_book_smallitem receptacle34_sink)
	(inreceptacle item71_book_smallitem receptacle26_toilet)
	(inreceptacle item43_book_smallitem receptacle2_chair)
	(inreceptacle item78_book_smallitem receptacle33_oven)
	(inreceptacle item17_potted_plant_largeitem receptacle37_refrigerator)
	(inreceptacle item70_book_smallitem receptacle4_chair)
	(inreceptacle item27_tv_largeitem receptacle9_chair)
	(inreceptacle item73_book_smallitem receptacle34_sink)))
)
