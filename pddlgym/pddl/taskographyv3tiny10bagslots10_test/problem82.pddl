...
(define (problem BenevolenceTaskographyv3Tiny10Bagslots10Problem82) (:domain taskographyv3tiny10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item9_book_smallitem receptacle34_bed)
	...
	(inreceptacle item31_potted_plant_largeitem receptacle37_dining_table)
	(inreceptacle item19_bowl_smallitem receptacle22_toilet)
	(inreceptacle item39_tv_largeitem receptacle36_dining_table)
	(inreceptacle item15_teddy_bear_mediumitem receptacle4_sink)
	(inreceptacle item18_bowl_smallitem receptacle25_chair)))
)
