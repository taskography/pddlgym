...
(define (problem LindenwoodTaskographyv3Tiny10Bagslots10Problem62) (:domain taskographyv3tiny10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item44_potted_plant_largeitem receptacle36_couch)
	...
	(inreceptacle item59_tv_largeitem receptacle36_couch)
	(inreceptacle item50_potted_plant_largeitem receptacle26_chair)
	(inreceptacle item13_book_smallitem receptacle25_chair)))
)
