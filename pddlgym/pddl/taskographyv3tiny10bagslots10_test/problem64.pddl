...
(define (problem LindenwoodTaskographyv3Tiny10Bagslots10Problem64) (:domain taskographyv3tiny10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	...
	(inreceptacle item17_vase_mediumitem receptacle58_dining_table)
	...
	(inreceptacle item39_potted_plant_largeitem receptacle19_toilet)
	(inreceptacle item15_bottle_smallitem receptacle5_sink)
	(inreceptacle item44_potted_plant_largeitem receptacle36_couch)
	(inreceptacle item12_book_smallitem receptacle34_chair)
