...
(define (problem LindenwoodTaskographyv3Tiny10Bagslots10Problem61) (:domain taskographyv3tiny10bagslots10)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg70_Ypos177_place3_room2_floorA)
  ...
  (:goal (and
	(inreceptacle item49_potted_plant_largeitem receptacle36_couch)
	(inreceptacle item14_clock_mediumitem receptacle19_toilet)
	(inreceptacle item42_potted_plant_largeitem receptacle1_oven)
	(inreceptacle item54_potted_plant_largeitem receptacle18_toilet)
	(inreceptacle item40_potted_plant_largeitem receptacle3_sink)
	(inreceptacle item51_potted_plant_largeitem receptacle9_refrigerator)
	(inreceptacle item52_potted_plant_largeitem receptacle30_chair)
	(inreceptacle item41_potted_plant_largeitem receptacle1_oven)
	(inreceptacle item46_potted_plant_largeitem receptacle56_bed)
	(inreceptacle item43_potted_plant_largeitem receptacle25_chair)))
)
