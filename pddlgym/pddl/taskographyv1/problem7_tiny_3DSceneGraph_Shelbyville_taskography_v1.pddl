...
(define (problem taskograph_rearrangement) (:domain taskographyv1)
  ...
  (:goal (and
	(inreceptacle item8_suitcase_largeitem receptacle66_toilet)
	(inreceptacle item52_potted_plant_largeitem receptacle36_chair)
	(inreceptacle item6_handbag_largeitem receptacle26_chair)
	(inreceptacle item50_potted_plant_largeitem receptacle24_chair)
	(inreceptacle item91_vase_mediumitem receptacle74_oven)
	(inreceptacle item3_backpack_largeitem receptacle63_dining_table)
	(inreceptacle item2_backpack_largeitem receptacle80_sink)
	(inreceptacle item13_bottle_smallitem receptacle29_chair)
	(inreceptacle item12_bottle_smallitem receptacle39_chair)
	(inreceptacle item87_vase_mediumitem receptacle27_chair)))
)
