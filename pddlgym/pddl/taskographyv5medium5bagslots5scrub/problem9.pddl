...
(define (problem goodfieldtaskographyv5medium5bagslots5problem9) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg66_yneg55_place15_room5_floorc)
	...
	(inplace robot place15_door_room5_closet)
