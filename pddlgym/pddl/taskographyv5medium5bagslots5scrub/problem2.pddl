...
(define (problem eagantaskographyv5medium5bagslots5problem2) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg82_ypos61_place7_room7_floorb)
