...
(define (problem goodfieldtaskographyv5medium5bagslots5problem10) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg29_yneg34_place20_room19_floora)
	...
	(inplace robot place20_door_room19_staircase)
