...
(define (problem eagantaskographyv5medium5bagslots5problem3) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item48_mouse_smallitem mouse)
	...
	(itemclass item64_toothbrush_smallitem toothbrush)
