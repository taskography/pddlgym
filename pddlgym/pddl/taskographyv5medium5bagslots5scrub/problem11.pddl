...
(define (problem goodfieldtaskographyv5medium5bagslots5problem11) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg5_yneg35_place11_room4_floorc)
