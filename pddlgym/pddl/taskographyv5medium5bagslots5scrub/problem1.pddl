...
(define (problem eagantaskographyv5medium5bagslots5problem1) (:domain taskographyv5medium5bagslots5scrub)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg70_ypos6_place8_room3_floorb)
	...
	(inplace robot place8_door_room3_bedroom)
