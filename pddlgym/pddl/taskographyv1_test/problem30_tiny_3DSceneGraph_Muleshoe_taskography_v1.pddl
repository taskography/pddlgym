...
(define (problem taskograph_rearrangement) (:domain taskographyv1)
  ...
  (:goal (and
	(inreceptacle item48_wine_glass_smallitem receptacle70_chair)
	(inreceptacle item39_vase_mediumitem receptacle1_oven)
	(inreceptacle item17_book_smallitem receptacle73_chair)
	(inreceptacle item52_wine_glass_smallitem receptacle82_chair)
	(inreceptacle item16_book_smallitem receptacle5_sink)
	(inreceptacle item22_book_smallitem receptacle114_bed)
	(inreceptacle item113_potted_plant_largeitem receptacle68_toilet)
	(inreceptacle item10_book_smallitem receptacle72_chair)
	(inreceptacle item51_wine_glass_smallitem receptacle1_oven)
	(inreceptacle item108_potted_plant_largeitem receptacle72_chair)))
)
