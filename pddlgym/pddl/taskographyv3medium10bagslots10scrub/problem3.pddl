...
(define (problem eagantaskographyv3medium10bagslots10problem3) (:domain taskographyv3medium10bagslots10scrub)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg41_ypos11_place0_room9_floora)
	...
	(inplace robot place0_door_room9_empty_room)
  ...
  (:goal (and
	(inreceptacle item62_vase_mediumitem receptacle42_dining_table)
	(inreceptacle item39_potted_plant_largeitem receptacle16_chair)
	(inreceptacle item7_bottle_smallitem receptacle12_chair)
	(inreceptacle item28_potted_plant_largeitem receptacle45_toilet)
	(inreceptacle item5_bottle_smallitem receptacle43_dining_table)
	(inreceptacle item26_potted_plant_largeitem receptacle12_chair)
	(inreceptacle item3_bottle_smallitem receptacle50_oven)
	(inreceptacle item32_potted_plant_largeitem receptacle14_chair)
	(inreceptacle item10_cake_mediumitem receptacle53_sink)
	(inreceptacle item23_potted_plant_largeitem receptacle41_bed)))
)
