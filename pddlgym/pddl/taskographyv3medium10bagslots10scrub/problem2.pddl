...
(define (problem eagantaskographyv3medium10bagslots10problem2) (:domain taskographyv3medium10bagslots10scrub)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg82_ypos60_place2_room1_floora)
  ...
  (:goal (and
	(inreceptacle item2_bottle_smallitem receptacle50_oven)
	(inreceptacle item8_bowl_smallitem receptacle11_chair)
	(inreceptacle item24_potted_plant_largeitem receptacle17_chair)
	(inreceptacle item63_vase_mediumitem receptacle16_chair)
	(inreceptacle item37_potted_plant_largeitem receptacle53_sink)
	(inreceptacle item6_bottle_smallitem receptacle14_chair)
	(inreceptacle item23_potted_plant_largeitem receptacle44_dining_table)
	(inreceptacle item38_potted_plant_largeitem receptacle54_sink)
	(inreceptacle item4_bottle_smallitem receptacle12_chair)
	(inreceptacle item64_toothbrush_smallitem receptacle52_sink)))
)
