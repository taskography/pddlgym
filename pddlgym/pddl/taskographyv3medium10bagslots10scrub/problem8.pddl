...
(define (problem goodfieldtaskographyv3medium10bagslots10problem8) (:domain taskographyv3medium10bagslots10scrub)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:init 
	(atlocation robot location_xneg60_yneg72_place13_room16_floorb)
	...
	(inplace robot place13_door_room16_kitchen)
  ...
  (:goal (and
	(inreceptacle item11_banana_smallitem receptacle27_couch)
	(inreceptacle item1_umbrella_largeitem receptacle34_bed)
	(inreceptacle item7_bottle_smallitem receptacle32_couch)
	(inreceptacle item63_vase_mediumitem receptacle26_chair)
	(inreceptacle item60_vase_mediumitem receptacle21_chair)
	(inreceptacle item61_vase_mediumitem receptacle47_sink)
	(inreceptacle item54_book_smallitem receptacle42_oven)
	(inreceptacle item57_vase_mediumitem receptacle20_chair)
	(inreceptacle item4_surfboard_largeitem receptacle16_chair)
