...
(define (problem goodfieldtaskographyv3medium10bagslots10problem10) (:domain taskographyv3medium10bagslots10scrub)
  (:objects
        bagslot1 - bagslot
	bagslot10 - bagslot
	bagslot2 - bagslot
  ...
  (:goal (and
	(inreceptacle item40_tv_largeitem receptacle15_chair)
	(inreceptacle item58_vase_mediumitem receptacle23_chair)
	(inreceptacle item14_cake_mediumitem receptacle32_couch)
	(inreceptacle item12_banana_smallitem receptacle36_bed)
	(inreceptacle item55_book_smallitem receptacle38_toilet)
	(inreceptacle item6_bottle_smallitem receptacle20_chair)
	(inreceptacle item7_bottle_smallitem receptacle36_bed)
	(inreceptacle item13_cake_mediumitem receptacle17_chair)
	(inreceptacle item56_clock_mediumitem receptacle17_chair)
	(inreceptacle item10_bowl_smallitem receptacle32_couch)))
)
