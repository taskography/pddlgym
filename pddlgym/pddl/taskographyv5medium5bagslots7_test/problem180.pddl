...
(define (problem ParoleTaskographyv5Medium5Bagslots7Problem180) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg44_Ypos11_place4_room2_floorA)
	(inplace robot place4_door_room2_bedroom)
