...
(define (problem SweatmanTaskographyv5Medium5Bagslots7Problem75) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg47_Ypos10_place7_room3_floorA)
