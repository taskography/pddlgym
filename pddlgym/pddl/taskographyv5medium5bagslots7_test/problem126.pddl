...
(define (problem AdairsvilleTaskographyv5Medium5Bagslots7Problem126) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg40_Ypos38_place5_room4_floorC)
	...
	(inplace robot place5_door_room4_bathroom)
