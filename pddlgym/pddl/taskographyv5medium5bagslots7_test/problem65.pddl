...
(define (problem SpringervilleTaskographyv5Medium5Bagslots7Problem65) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos39_Ypos66_place8_room10_floorA)
	...
	(inplace robot place8_door_room10_living-room)
	...
	(inroom robot room10_living-room)
