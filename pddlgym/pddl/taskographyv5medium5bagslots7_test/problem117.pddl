...
(define (problem WaipahuTaskographyv5Medium5Bagslots7Problem117) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(itemclass item4_suitcase_largeitem suitcase)
	...
	(receptacleclass receptacle45_microwave microwave)
	(receptacleclass receptacle46_oven oven)
