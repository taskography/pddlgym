...
(define (problem FrankfortTaskographyv5Medium5Bagslots7Problem213) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos9_Yneg1_place11_room14_floorA)
	...
	(inplace robot place11_door_room14_utility_room)
	...
	(inroom robot room14_utility_room)
	...
	(itemclass item35_remote_smallitem remote)
