...
(define (problem AnaheimTaskographyv5Medium5Bagslots7Problem77) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg12_Ypos3_place6_room13_floorB)
	...
	(inplace robot place6_door_room13_dining_room)
