...
(define (problem SouthfieldTaskographyv5Medium5Bagslots7Problem80) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg123_Ypos22_place5_room7_floorA)
	...
	(inplace robot place5_door_room7_empty_room)
