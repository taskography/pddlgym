...
(define (problem AnnonaTaskographyv5Medium5Bagslots7Problem84) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg1_Ypos79_place3_room16_floorA)
	...
	(inplace robot place3_door_room16_storage)
	...
	(itemclass item27_banana_smallitem banana)
	(itemclass item28_toothbrush_smallitem toothbrush)
	...
	(receptacleclass receptacle26_bench bench)
