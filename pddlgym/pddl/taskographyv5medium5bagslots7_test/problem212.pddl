...
(define (problem FrankfortTaskographyv5Medium5Bagslots7Problem212) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg2_Ypos38_place13_room13_floorA)
	...
	(inplace robot place13_door_room13_staircase)
