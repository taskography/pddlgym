...
(define (problem LynchburgTaskographyv5Medium5Bagslots7Problem216) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos45_Ypos4_place11_room10_floorA)
	...
	(inplace robot place11_door_room10_living_room)
