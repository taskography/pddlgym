...
(define (problem OyensTaskographyv5Medium5Bagslots7Problem210) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xpos3_Ypos2_place9_room7_floorA)
