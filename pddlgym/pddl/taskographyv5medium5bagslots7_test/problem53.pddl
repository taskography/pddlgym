...
(define (problem TilghmantonTaskographyv5Medium5Bagslots7Problem53) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg4_Ypos13_place0_room10_floorA)
