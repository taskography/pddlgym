...
(define (problem CastorTaskographyv5Medium5Bagslots7Problem177) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg1_Yneg24_place1_room9_floorB)
	...
	(inplace robot place1_door_room9_empty_room)
