...
(define (problem HillsdaleTaskographyv5Medium5Bagslots7Problem200) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	...
	(receptacleclass receptacle29_oven oven)
	(receptacleclass receptacle30_oven oven)
