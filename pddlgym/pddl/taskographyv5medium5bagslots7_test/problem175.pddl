...
(define (problem GoodyearTaskographyv5Medium5Bagslots7Problem175) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg24_Yneg8_place16_room7_floorC)
	...
	(inplace robot place16_door_room7_corridor)
