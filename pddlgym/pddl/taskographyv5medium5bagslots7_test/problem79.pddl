...
(define (problem ClairtonTaskographyv5Medium5Bagslots7Problem79) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg11_Yneg29_place2_room3_floorA)
