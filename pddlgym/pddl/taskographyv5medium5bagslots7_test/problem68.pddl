...
(define (problem PameliaTaskographyv5Medium5Bagslots7Problem68) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg52_Yneg4_place9_room3_floorA)
	...
	(inplace robot place9_door_room3_bedroom)
	...
	(itemclass item10_handbag_largeitem handbag)
	(itemclass item11_surfboard_largeitem surfboard)
	...
	(itemclass item21_banana_smallitem banana)
	(itemclass item22_banana_smallitem banana)
	(itemclass item23_orange_smallitem orange)
	...
	(itemclass item49_laptop_mediumitem laptop)
	(itemclass item50_mouse_smallitem mouse)
	(itemclass item51_mouse_smallitem mouse)
	...
	(itemclass item81_teddy_bear_mediumitem teddybear)
	(itemclass item82_teddy_bear_mediumitem teddybear)
	(itemclass item83_teddy_bear_mediumitem teddybear)
	(itemclass item84_teddy_bear_mediumitem teddybear)
	(itemclass item85_teddy_bear_mediumitem teddybear)
	(itemclass item9_umbrella_largeitem umbrella)
	...
	(largeitem item9_umbrella_largeitem)
	...
	(mediumitem item81_teddy_bear_mediumitem)
	(mediumitem item82_teddy_bear_mediumitem)
	(mediumitem item83_teddy_bear_mediumitem)
	(mediumitem item84_teddy_bear_mediumitem)
	(mediumitem item85_teddy_bear_mediumitem)
	...
	(receptacleclass receptacle55_toaster toaster)
	...
	(smallitem item23_orange_smallitem)
	(smallitem item50_mouse_smallitem)
	(smallitem item51_mouse_smallitem)
