...
(define (problem NuevoTaskographyv5Medium5Bagslots7Problem194) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg8_Yneg30_place3_room1_floorA)
