...
(define (problem HordvilleTaskographyv5Medium5Bagslots7Problem55) (:domain taskographyv5medium5bagslots7)
  (:objects
        apple - iclass
	backpack - iclass
	bagslot1 - bagslot
  ...
  (:init 
	(atlocation robot location_Xneg68_Yneg2_place3_room1_floorA)
